...
#pragma attol crc_justify_all (Rule M18.1, 2, "Rule M18.1 is not applied here as the structure delaration is needed for the compilation of sglInit.")
#endif
...
OGLXAPI void sglClipBox(SGLlong par_l_number, SGLbyte par_b_type, SGLfloat par_f_x_bottom_left, SGLfloat par_f_y_bottom_left, SGLfloat par_f_x_top_right,
                        SGLfloat par_f_y_top_right);

#ifndef OGLX_NO_GLCLIPPLANE
OGLXAPI void sglClipPlane(SGLlong par_l_number, SGLfloat par_f_start_point_x, SGLfloat par_f_start_point_y, SGLfloat par_f_angle, SGLbool par_b_clockwise);
#endif
...
#ifdef ATTOL_CRC_PRAGMA
#pragma attol crc_justify_all (Rule M6.3, 2, "Rule M6.3 is not applied here, this is the only usage of char in OGLX. It is used to return a string")
#endif
...
OGLXAPI SGLbool sglShapeActiveAreaGetStatus(SGLfloat par_f_mouse_x, SGLfloat par_f_mouse_y, SGLlong par_l_nb_points, SGLfloat par_pf_points[][2]);
...
#else
#define SGLfloat_to_uint64(x)	sglFloatToUInt32(x)
#define SGLdouble_to_uint64(x)	sglDoubleToUInt32(x)
#endif
