...
#define GLF_GET_CHAR(F,I) ((const glf_type_character*)(((const SGLbyte*)(F)) + ((F)->ui_offset_characters + ((F)->us_char_size * (F)->tus_delta_chars[I]))))
...
#define GLF_GET_STROKE_CHAR(C) ((glf_type_character_stroke*)(C))
...
#define GLF_GET_BITMAP_CHAR(C) ((glf_type_character_bitmap*)(C))
#define GLF_GET_DELTA_WIDTH(F,W) ((F)->tub_delta_widths[W])
#define GLF_GET_DELTA_HALO_WIDTH(F,W) ((F)->tub_delta_halo_widths[W])

#define GLF_GET_STROKE_DATA(F) (((SGLbyte*)(F)) + (F)->ui_offset_strokes)
