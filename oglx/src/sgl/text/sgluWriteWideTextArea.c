/** FILE DESCRIPTION -------------------------------------------------------
 FILENAME          : sgluWriteWideTextArea.c
 DESCRIPTION       : sgluWriteWideTextArea command shall draw a text area in unicode format
...
/*+ FUNCTION DESCRIPTION ----------------------------------------------
  ...
  RETURN:
    None
---------------------------------------------------------------------+*/
void sgluWriteWideTextArea(SGLfloat par_f_x_bottom_left, SGLfloat par_f_y_bottom_left, SGLfloat par_f_x_top_right, SGLfloat par_f_y_top_right,
                           const SGLushort * par_pus_string, SGLlong par_l_string_length)
{
    ...
    if ((par_l_string_length >= 0) && (par_pus_string != SGL_NULL)) {
        ...
        while ((loc_ul_i < (SGLulong) par_l_string_length) && (par_pus_string[loc_ul_i] != 0)) {
            loc_ul_i++;
        }
        ...
        while (((SGLulong) par_l_string_length < loc_ui_param_length) && (par_pus_string[par_l_string_length] != 0)) {
            glob_us_string[par_l_string_length] = par_pus_string[par_l_string_length];
            par_l_string_length++;
        }
        ...
        oglxSetError(SGL_ERROR_SGLU_WRITEWIDETEXTAREA, 0U);
    }
